...
contract DeflatingLinkswapERC20Test is ILinkswapERC20 {
    using SafeMathLinkswap for uint256;

    string public constant override name = "Deflating Test Token";
    string public constant override symbol = "DTT";
